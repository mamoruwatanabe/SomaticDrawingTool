...
namespace MK.Glass
{
    ...
    public class MKGlassEditor : ShaderGUI
    {
        ...
        {
            public static GUIContent zWrite = new GUIContent("Z-Write", "Write Into Depth Buffer");
        ...
        private MaterialProperty diffuseIntensity = null;
        ...
        public void FindProperties(MaterialProperty[] props, Material mat)
        {
            ...
            zWrite = FindProperty(MKGlassMaterialHelper.PropertyNames.Z_WRITE, props);
            ...
            diffuseIntensity = FindProperty(MKGlassMaterialHelper.PropertyNames.DIFFUSE_INTENSITY, props);
        ...
        override public void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if (HandleBehavior("Light", ref showLightBehavior, materialEditor))
            {
                ...
                if (lightModel.floatValue != (int)(LightModel.Unlit))
                {
                    materialEditor.ShaderProperty(diffuseIntensity, "Diffuse Intensity");
                }
            }
            ...
            if (HandleBehavior("Render", ref showRenderBehavior, materialEditor))
            {
                ...
                //materialEditor.ShaderProperty(zWrite, GUIContentCollection.zWrite);
