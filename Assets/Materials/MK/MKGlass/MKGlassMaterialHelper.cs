...
namespace MK.Glass
{
    public static class MKGlassMaterialHelper
    {
        public static class PropertyNames
        {
            ...
            public const string Z_WRITE = "_MKGlassZWrite";
            ...
            public const string DIFFUSE_INTENSITY = "_DiffuseIntensity";
        ...
        public static void SetDiffuseIntensity(Material material, float intensity)
        {
            material.SetFloat(PropertyNames.DIFFUSE_INTENSITY, intensity);
        }
        public static float GetDiffuseIntensity(Material material)
        {
            return material.GetFloat(PropertyNames.DIFFUSE_INTENSITY);
        }
